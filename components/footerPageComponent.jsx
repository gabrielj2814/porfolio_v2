                    ...
                    <div className="col-12 col-ms-12 col-md-12 col-lg-6">
                        <div className="row">
                            <div className="col-12 mb-3 text-center text-lg-start">
                                <h4>Contacto:</h4>
                                <a href="mailto:gabrielj2814@hotmail.com">gabrielj2814@hotmail.com</a>
                            </div>
                            <div className="col-12 mb-3 text-center text-lg-start">
                                <h4>Redes:</h4>
                                ...
                                <a href="https://www.tiktok.com/@gabrielvalera.ts" target="_blank" rel="noreferrer" className="link-icon-footer">
